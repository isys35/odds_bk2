...
class Grabber:
    ...
    def get_match_data(self, url):
        ...
        json_text = re.search('globals\.jsonpCallback\(.*, (.*)\);', resp.text)
...
if __name__ == '__main__':
    grabber = Grabber()
    grabber.get_match_data('https://www.oddsportal.com/handball/africa/african-championship/egypt-tunisia-2uqxZtkE/')
